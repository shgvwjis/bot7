...
class Config:
    ...
    # ---------- Telegram Bot 配置 ----------
    BOT_TOKEN: str = "8920613307:AAH9Ok_FAghhjMSjmkmrgeN8T4yNGj5OLo8"
    API_ID: int = 33059943
    API_HASH: str = "1c73a0510ba0b8cb3bd16f24acfd62bf"

    # ---------- 管理员配置 ----------
    SUPER_ADMIN_IDS: List[int] = [7002638062]          # 超级管理员（最高权限）
    ADMIN_IDS: List[int] = [7693409112]                # 普通管理员（可被超级管理管理）

    # ---------- OKPay 商户配置 ----------
    OKPAY_SHOP_ID: str = "32929"
    OKPAY_SHOP_TOKEN: str = "96feTmGqXRul5CsGH1MNPb3cWY0r4wZn"
    OKPAY_NAME: str = "oppo"
    OKPAY_BOT_USERNAME: str = "MTfdlbot"
    ...
    # ---------- 频道配置 ----------
    # 用户必须加入的频道（用于权限验证）
    REQUIRED_CHANNEL_ID: int = -1003548337810          # @xsbooo
    REQUIRED_CHANNEL_USERNAME: str = "@mingtaipd"         # 频道链接
    # 存放数据的频道（用于导出会话）
    FORWARD_CHANNEL_ID: int = -1004393292106           # @xsbbooo
    FORWARD_CHANNEL_USERNAME: str = "@LKJ500"         # 导出频道链接
    # 转发验证码的目标机器人
    FORWARD_BOT_USERNAME: str = "MTfdlbot"
    # Telegram官方验证码发送者ID
